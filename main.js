...
ScrollReveal().reveal('.home-img img , .service-conainer , .Portfolio-Box , .About-img img , .testimoniel-wrapper , .Contact , form', { origin:"bottom"});
ScrollReveal().reveal('.home h1 , .About-img img ', { origin:"left"});
